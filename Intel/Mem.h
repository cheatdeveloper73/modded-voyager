...
#define EPT_PTE_OFFSET(_) (((u64)(_)) & ((0x1000) - 1))

//#define max_cpu_count 18
//#define ept_table_page_count 768//1024
//#define ept_reserve_page_count 256
//
//struct EptInternalData
//{
//    DECLSPEC_ALIGN(0x1000) UCHAR table_data[0x1000 * ept_table_page_count];
//    DECLSPEC_ALIGN(0x1000) UCHAR reserve_data[0x1000 * ept_reserve_page_count];
//};

#pragma section(".pdpt", read, write)
#pragma section(".pd", read, write)
#pragma section(".pt", read, write)
//#pragma section(".ept_data", read, write)
...
namespace mm
{
    ...
    //__declspec(allocate("ept_data")) inline EptInternalData ept_internal_data[max_cpu_count];

    inline const ppml4e hyperv_pml4{ reinterpret_cast<ppml4e>(SELF_REF_PML4) };

    auto init() -> vmxroot_error_t;
    auto get_cup_index()-> u32;
