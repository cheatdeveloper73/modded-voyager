...
//#define offset_vmcb_base 0x10398 //Win 11
//#define offset_vmcb_link 0x318
//#define offset_vmcb 0x1080

//#if WINVER == 2004
#define offset_vmcb_base 0x103A0 //21h2
#define offset_vmcb_link 0x298
#define offset_vmcb 0xE80
//
//#define offset_vmcb_base 0x103B0 //2004
...
namespace svm
{
	...
	typedef struct _voyager_t
	{
		...
		//u64 xoffset_vmcb_base;
		//u64 xoffset_vmcb_link;
		//u64 xoffset_vmcb;
	...
	{
		return *reinterpret_cast<svm::pvmcb*>(*reinterpret_cast<u64*>(*reinterpret_cast<u64*>(__readgsqword(0) + offset_vmcb_base) + offset_vmcb_link) + offset_vmcb);
	}
}